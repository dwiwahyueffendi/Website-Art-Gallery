...
INSERT INTO `post` (`IDPOST`, `GAMBAR`, `DESKRIPSI`, `TANGGALPOST`, `JUMLAHLIKE`, `IDKATEGORI`, `USERNAME`, `TITLE`, `THUMBNAIL`) VALUES
...
(28, 'Image/img/nature9.jpg', 'This massive park can be found on Kentucky\'s border and is definitely one of the most beautiful in the nation.', '2021-01-02', 400, 4, 'jukyo', '', ''),
